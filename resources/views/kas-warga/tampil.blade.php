            ...
            <div class="card-body">
               <div class="row">
                  ...
                  <div class="col-6">
                     ...
                     <div
                        class="form-group div-kategori d-none"
                     ...
                     {{--
                     <button class="btn btn-primary mt-4" id="filter">
                        Filter
                     </button>
                     --}}
                  </div>
      ...
      <div class="col-12">
         <div class="card">
            <div class="card-body">
               ...
               <table
                  width="100%"
                  class="table table-bordered mb-0 table-responsive"
               >
                  <thead>
                     <option value=""></option>
                     <tr>
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td class="text-center">
                           <a
                              href="/kas-warga/lihat/{{ $item->id }}"
                              class="btn btn-sm btn-primary m-1"
                              >Lihat</a
                           >
                           <a
                              href="/kas-warga/ubah/{{ $item->id }}"
                              class="btn btn-sm btn-warning m-1"
                              >Ubah</a
                           >
                           <a
                              href="/kas-warga/hapus/{{ $item->id }}"
               ...
               <br />
               <div id="paginate">{{ $kas_warga->links() }}</div>
            </div>
         </div>
      </div>
   </div>
