...
<body>
   ...
   @include('dashboard.chart4') @include('dashboard.chart1')
   @include('dashboard.chart2') @include('dashboard.chart3')
   @include('dashboard.chart5') @include('dashboard.chart6') @include ('footer')
</body>
