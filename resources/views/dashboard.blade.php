...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion"
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo"
                    ...
                    <div class="collapse-inner bg-white py-2 rounded">
        ...
        <div id="content-wrapper"
            ...
            <div id="content">
                <!-- Topbar -->
                <nav class="navbar navbar-expand navbar-light topbar static-top bg-white mb-4 shadow">
                    ...
                    <!-- Topbar Search -->
                    <form
                          class="d-none d-sm-inline-block form-inline ml-md-3 my-md-0 mw-100 navbar-search mr-auto my-2">
                        <div class="input-group">
                            <input type="text"
                                   class="form-control bg-light small border-0"
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle"
                               ...
                               aria-haspopup="true"
                               aria-expanded="false">
                                <span class="d-none d-lg-inline small mr-2 text-gray-600">Douglas
                                    McGee</span>
