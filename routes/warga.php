...
Route::post("/warga/post-tambah", function (
    Request $request
) {
    ...
    if ($warga) {
        return redirect("/warga/tampil")->with(
            "message",
            "Berhasil Menambah!"
        );
    } else {
        return redirect("/warga/tampil")->withErrors(
            "error",
            "Gagal!"
        );
    }
...
Route::post("/warga/post-ubah/{id}", function (
    Request $request,
    $id
) {
...
Route::post("/warga/post-import", function (
    Request $request
) {
    $excel = Excel::import(
        new WargaImport(),
